                    ...
                    <div class="card border rounded-3">
                        ...
                        <div class="card-header border-bottom">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <h5 class="mb-2 mb-sm-0">Liste des Marques</h5>
                            </div>
                        </div>
                        <!-- Card header END -->
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        @foreach ($affiche_marque as $resultat)
                                            <tr>
                                                ...
                                                <td> <h6 class="mb-0 text-center"><a href="#">{{$resultat->ref_marque}}</a></h6> </td>
                                                <td> <h6 class="mb-0 text-center"><a href="#">{{$resultat->libelle_marque}}</a></h6></td>
                                                {{-- <td> <h6 class="mb-0 text-center"><a href="#"></a></h6></td> --}}
                            ...
                            <div class="card bg-light w-100">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <ul class="nav nav-pills-primary-soft flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{url('admin/AjouterMarque')}}"><i class="bi bi-patch-check fa-fw me-2"></i>Marques</a>
                                        </li>
                                        <li class="nav-item">
