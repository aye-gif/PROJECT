                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        @foreach ($affiche_fournisseur as $resultat)
                                            <tr>
                                                ...
                                                <td> <h6 class="mb-0"><a href="#">{{$resultat->ref_fournisseur}}</a></h6> </td>
                                                <td> <h6 class="mb-0"><a href="#">{{$resultat->libelle_fournisseur}}</a></h6></td>
                                                <td> <h6 class="mb-0"><a href="#">{{$resultat->telephone}}</a></h6></td>
                            ...
                            <div class="card bg-light w-100">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <ul class="nav nav-pills-primary-soft flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{url('admin/AjouterFournisseur')}}"><i class="bi bi-heart fa-fw me-2"></i>Fournisseur</a>
                                        </li>
